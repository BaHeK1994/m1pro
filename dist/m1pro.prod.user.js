...
class ChanceRangeElem {
    ...
    static computeIfAbsent(cre, range) {
        ...
        <div class="Info-wrap">
            ...
            <div class="Info-content">
                ...
                <div class="Info-pro" :class='{selected: showPro}'>
                    <div class="Info-pro-head">Текущая версия: ${"1.0.3"}</div>
...
class HeaderMenu {
    ...
    checkVersion() {
        this.state.isUnseen("1.0.3") ? this.verBadge.show() : this.verBadge.hide();
    }
}
...
class Banner {
    constructor(state) {
        ...
        if (localStorage.getItem('m1pro_banner_hidden') !== '1') {
            state.onCallMethod("execute.games", (v) => {
                this.init();
                return true;
            });
        }
